...
INSERT INTO users (name, birthday_at, created_at, updated_at) VALUES
  ...
  ('Иван', '1998-01-12', '20.10.2017 8:11', '20.10.2017 8:11'),
  ('Мария', '1992-08-29', '20.10.2017 8:13', '20.10.2017 8:14');
/*
Решение 2 задачи, испробованы следующие способы конвертации данных из строчного формата в дату но ни один не сработал
...
то есть в новом столбце нулевым значениям присвоить большое значение и далее сортировать по возрастанию но данный код не работает*/
