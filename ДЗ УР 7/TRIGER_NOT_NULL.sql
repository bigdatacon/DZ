/*В таблице products есть два текстовых поля: name с названием товара и description с его описанием.
 ...
 /* Решение на строках 151 - 155, решение не дает ввести в таблицу нул значение но при попытке ввести нул
 значение не выдает никакой ошибки. При это при исполнении только кода с тригера выдается ошибка 
 описанная на строке 8*/
